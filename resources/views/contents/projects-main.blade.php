            ...
            <div class="slides-1 portfolio-details-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    ...
                    <div class="swiper-slide">
                        <img src="{{ asset('img/website/dredging1.jpg') }}" alt=""
                            style="max-height: 972px">
                    </div>

                    <div class="swiper-slide">
                        <img src="{{ asset('img/website/dredging2.jpg') }}" alt=""
                            style="max-height: 972px">
                    </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
            ...
            <div class="col-lg-8">
                <div class="portfolio-description">
                    <h2>Dredging</h2>
                    <p>
                        Welcome to our website, where we offer comprehensive dredging services for construction and
                        mining projects. Our experienced team uses state-of-the-art equipment to efficiently remove
                        sediment and debris from water bodies, improving navigability and restoring water depths. With
                        our expertise and commitment to sustainable practices, we deliver exceptional results for
                        projects of all scales. Choose us for a seamless and efficient dredging process from start to
                        finish.
...
<section id="project-details" class="project-details">
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row justify-content-between gy-4 mt-4">
            ...
            <div class="col-lg-8">
                <div class="portfolio-description">
                    <h2>Mining & Dredging</h2>
                    <p>
                        Welcome to our website, where we specialize in providing comprehensive mining services for
                        various projects. Our skilled team utilizes advanced equipment and techniques to ensure
                        efficient and responsible mining operations. With a focus on safety, sustainability, and
                        environmental stewardship, we deliver exceptional results for mining ventures of all sizes.

                        At our company, we offer a range of mining services, including exploration, extraction,
                        processing, and reclamation. Our experienced professionals are dedicated to maximizing mineral
                        recovery while minimizing environmental impact. We adhere to stringent regulations and best
                        practices to ensure the responsible management of resources and the protection of surrounding
                        ecosystems.

                        Whether you're in need of surface mining, underground mining, or mineral processing services, we
                        have the expertise to handle your project. Our commitment to operational excellence,
                        technological innovation, and sustainable practices sets us apart in the mining industry.

                        Choose us as your trusted partner for seamless and efficient mining operations. Contact us today
                        to discuss your mining needs and discover how we can contribute to the success of your project.
        ...
        <div class="position-relative h-100">
            <div class="slides-1 portfolio-details-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    ...
                    <div class="swiper-slide">
                        <img src="{{ asset('img/website/quarrying1.jpg') }}" alt=""
                            style="max-height: 972px">
                    </div>

                    <div class="swiper-slide">
                        <img src="{{ asset('img/website/quarrying2.jpg') }}" alt=""
                            style="max-height: 972px">
                    </div>

                    <div class="swiper-slide">
                        <img src="{{ asset('img/website/quarrying3.jpg') }}" alt=""
                            style="max-height: 972px">
                    </div>
            ...
            <div class="col-lg-8">
                <div class="portfolio-description">
                    ...
                    <p>
                        ...
                        At [partROCK], we specialize in extracting and supplying high-quality quarry materials for
                        construction projects. With state-of-the-art equipment and a skilled team, we deliver reliable
                        aggregates, sand, gravel, and stone. Our commitment to safety and sustainability ensures
                        responsible quarrying practices. Contact us for your quarry material needs.
                    </p>
        ...
        <div class="position-relative h-100">
            <div class="slides-1 portfolio-details-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    ...
                    <div class="swiper-slide">
                        <img src="{{ asset('img/website/valle verde.jpg') }}" alt=""
                            style="max-height: 972px">
                    </div>
