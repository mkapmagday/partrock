                    ...
                    <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up">
                        <div class="content">
                            ...
                            <p>Mining, Quarrying, and Crushing Plant Operation/Management 
                                ...
                                Supplier of Silica, Quartz, Dredged Sea Sand, Iron/Magnetic Sand, Aggregates, Blasted Armor Rock, Boulders and other Minerals.
                        </div>
                    </div>
        ...
        <section id="services" class="services section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>Services</h2>
                    <p>Our company offers a wide range of construction services including aggregates, cement, filling materials, silica, coal, iron ore, dolomite, boulders, dredged materials, mining contractor, development general contractor, reclamation, dredging earthworks, drilling, blasting equipment, and van rentals. We provide high-quality materials and equipment, coupled with skilled professionals who are committed to delivering excellent results. We prioritize safety, efficiency, and customer satisfaction in every project we undertake.</p>
                </div>
                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-item  position-relative">
                          ...
                          <h3>Aggregates</h3>
                          <p>We offer a wide range of high-quality aggregates for all your construction needs, including sand, gravel, crushed stone, and more.</p>
                      ...
                      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="service-item position-relative">
                          ...
                          <h3>Cement</h3>
                          <p>Our premium cement products are perfect for any construction project, offering strength, durability, and versatility.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="service-item position-relative">
                          ...
                          <p>We provide a variety of filling materials, such as topsoil and backfill, to help you create a solid foundation for your building or structure.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="service-item position-relative">
                          ...
                          <h3>Silica</h3>
                          <p>Our high-quality silica products are perfect for use in a range of construction applications, including concrete, mortar, and more.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="service-item position-relative">
                          ...
                          <h3>Coal</h3>
                          <p>We supply high-quality coal for a range of industrial applications, including power generation and cement production.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
                        <div class="service-item position-relative">
                          ...
                          <h3>Iron Ore</h3>
                          <p>Our iron ore products are ideal for use in steel production, offering high levels of purity and consistency.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="700">
                        <div class="service-item position-relative">
                          ...
                          <h3>Dolomite</h3>
                          <p>Our dolomite products are perfect for use in a range of construction applications, including road construction and building foundations.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="800">
                        <div class="service-item position-relative">
                          ...
                          <h3>Boulders</h3>
                          <p>We provide a range of boulders in different sizes, perfect for use in landscaping, erosion control, and other construction applications.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="900">
                        <div class="service-item position-relative">
                          ...
                          <p>Our dredged materials are ideal for use in a range of marine construction projects, including harbor deepening, beach nourishment, and more.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="1000">
                        <div class="service-item position-relative">
                          ...
                          <p>We provide expert mining contractor services, including exploration, development, and operation, to help you maximize your mineral resources.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="1100">
                        <div class="service-item position-relative">
                          ...
                          <p>Our development general contractor services are ideal for any construction project, offering expertise in design, planning, and execution.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="1200">
                        <div class="service-item position-relative">
                          ...
                          <h3>Reclamation</h3>
                          <p>We provide comprehensive reclamation services to help restore land to its original state after mining or other industrial activities.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="1300">
                        <div class="service-item position-relative">
                          ...
                          <p>Our dredging earthworks services are ideal for any marine construction project, offering expertise in dredging, reclamation, and other earthworks.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="1400">
                        <div class="service-item position-relative">
                          ...
                          <h3>Drilling</h3>
                          <p>We provide expert drilling services for a range of applications, including geotechnical exploration, mining, and more.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="1500">
                        <div class="service-item position-relative">
                          ...
                          <p>Our high-quality blasting equipment is perfect for use in mining, construction, and other industrial applications.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                      ...
                      <div class="col-lg-4 col-md-6 hidden" data-aos="fade-up" data-aos-delay="1600">
                        <div class="service-item position-relative">
                          ...
                          <h3>Van Rentals</h3>
                          <p>We offer a range of reliable and affordable van rentals to help you transport your equipment and personnel to your construction site.</p>
                          <a href="service-details.html" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div><!-- End Service Item -->
                    ...
                    <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/1.jpg') }}" class="img-fluid"
                                    alt="">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-culvert">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/culvert/1.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/2.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-culvert">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/culvert/2.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/3.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-culvert">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/culvert/3.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/4.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/5.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/6.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-culvert">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/culvert/6.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/7.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-culvert">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/culvert/7.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/8.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-culvert">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/culvert/8.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/9.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-culvert">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/culvert/9.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-mezzanine">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/mezzanine/10.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-culvert">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('img/culvert/10.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Construction 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
